...
if __name__ == '__main__':
    file_path = 'experiment result_random_E.xlsx'  # 替换成您的 Excel 文件路径
    ...
    'CPU Running Time', 'CPU Running Time', 'Current Memory Allocation', 'Peak Memory Usage',
    'The number of traversed edges', 'The number of traversed edges'))
    ...
    fig.add_trace(trace_a_star_current, row=2, col=1)
    fig.add_trace(trace_LRTA_current, row=2, col=1)
    fig.add_trace(trace_tt_IDA_current, row=2, col=1)
    fig.add_trace(trace_IIDA_current, row=2, col=1)
    fig.add_trace(trace_a_star_peak, row=2, col=2)
    fig.add_trace(trace_LRTA_peak, row=2, col=2)
    fig.add_trace(trace_tt_IDA_peak, row=2, col=2)
    fig.add_trace(trace_IIDA_peak, row=2, col=2)
    fig.add_trace(trace_a_star_edge, row=3, col=1)
    fig.add_trace(trace_IIDA_edge, row=3, col=1)
    fig.add_trace(trace_LRTA_edge, row=3, col=2)
    fig.add_trace(trace_tt_IDA_edge, row=3, col=2)
    ...
    fig.add_trace(trace_a_star_current_2, row=2, col=1)
    fig.add_trace(trace_LRTA_current_2, row=2, col=1)
    fig.add_trace(trace_tt_IDA_current_2, row=2, col=1)
    fig.add_trace(trace_IIDA_current_2, row=2, col=1)
    fig.add_trace(trace_a_star_peak_2, row=2, col=2)
    fig.add_trace(trace_LRTA_peak_2, row=2, col=2)
    fig.add_trace(trace_tt_IDA_peak_2, row=2, col=2)
    fig.add_trace(trace_IIDA_peak_2, row=2, col=2)
    fig.add_trace(trace_a_star_edge_2, row=3, col=1)
    fig.add_trace(trace_IIDA_edge_2, row=3, col=1)
    fig.add_trace(trace_LRTA_edge_2, row=3, col=2)
    fig.add_trace(trace_tt_IDA_edge_2, row=3, col=2)
