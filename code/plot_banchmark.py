...
if __name__ == '__main__':
    ...
    trace_LRTA_D_2 = go.Scatter(x=tt_IDA_time_D_2, y=tt_IDA_peak_D_2, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_D_2 = go.Scatter(x=LRTA_time_D_2, y=LRTA_peak_D_2, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_D_3 = go.Scatter(x=tt_IDA_time_D_3, y=tt_IDA_peak_D_3, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_D_3 = go.Scatter(x=LRTA_time_D_3, y=LRTA_peak_D_3, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_D_4 = go.Scatter(x=tt_IDA_time_D_4, y=tt_IDA_peak_D_4, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_D_4 = go.Scatter(x=LRTA_time_D_4, y=LRTA_peak_D_4, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_M_1 = go.Scatter(x=tt_IDA_time_M_1, y=tt_IDA_peak_M_1, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_M_1 = go.Scatter(x=LRTA_time_M_1, y=LRTA_peak_M_1, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_M_2 = go.Scatter(x=tt_IDA_time_M_2, y=tt_IDA_peak_M_2, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_M_2 = go.Scatter(x=LRTA_time_M_2, y=LRTA_peak_M_2, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_M_3 = go.Scatter(x=tt_IDA_time_M_3, y=tt_IDA_peak_M_3, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_M_3 = go.Scatter(x=LRTA_time_M_3, y=LRTA_peak_M_3, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_M_4 = go.Scatter(x=tt_IDA_time_M_4, y=tt_IDA_peak_M_4, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_M_4 = go.Scatter(x=LRTA_time_M_4, y=LRTA_peak_M_4, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_E_1 = go.Scatter(x=tt_IDA_time_E_1, y=tt_IDA_peak_E_1, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_E_1 = go.Scatter(x=LRTA_time_E_1, y=LRTA_peak_E_1, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_E_2 = go.Scatter(x=tt_IDA_time_E_2, y=tt_IDA_peak_E_2, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_E_2 = go.Scatter(x=LRTA_time_E_2, y=LRTA_peak_E_2, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_E_3 = go.Scatter(x=tt_IDA_time_E_3, y=tt_IDA_peak_E_3, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_E_3 = go.Scatter(x=LRTA_time_E_3, y=LRTA_peak_E_3, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
    ...
    trace_LRTA_E_4 = go.Scatter(x=tt_IDA_time_E_4, y=tt_IDA_peak_E_4, mode='markers', name='LRTA*', marker=dict(color='royalblue', opacity=o, size=s))
    trace_tt_IDA_E_4 = go.Scatter(x=LRTA_time_E_4, y=LRTA_peak_E_4, mode='markers', name='TT IDA*', marker=dict(color='#f207e7', opacity=o, size=s))
